...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">เพิ่มข้อมูลวิชาเอก (Submajor)</li>
@endsection
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                    <h3 class="mb-0">เพิ่มข้อมูลวิชาเอก (Submajor)</h3>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.submajors.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="submajor_id" class="form-label fw-bold">รหัสวิชาเอก</label>
                            <input type="text" class="form-control @error('submajor_id') is-invalid @enderror" id="submajor_id" name="submajor_id" value="{{ old('submajor_id') }}" required>
                            @error('submajor_id')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('submajor_name_thai') is-invalid @enderror" id="submajor_name_thai" name="submajor_name_thai" value="{{ old('submajor_name_thai') }}" required>
