...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">แก้ไขข้อมูลเล่มหลักสูตร (Curriculum)</li>
@endsection
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('major_id') is-invalid @enderror" id="major_id" name="major_id" required>
                                ...
                                @foreach($majors as $major)
                                    <option value="{{ $major->id }}" {{ old('major_id', $curriculum->major_id) == $major->id ? 'selected' : '' }}>
