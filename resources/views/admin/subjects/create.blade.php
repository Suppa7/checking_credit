                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.subjects.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select2 @error('type_name') is-invalid @enderror" id="type_name" name="type_name" required>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select select2 @error('subject_own_id') is-invalid @enderror" id="subject_own_id" name="subject_own_id">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="curriculum_ids[]" id="curriculum_ids" multiple class="form-select select2">
